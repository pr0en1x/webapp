...
import com.haulmont.application.backend.BackendService;
import com.haulmont.application.backend.Employee;
...
import com.haulmont.application.MainView;
@Route(value = "Recipes", layout = MainView.class)
@PageTitle("Recipes")
@CssImport("styles/views/recipes/recipes-view.css")
public class RecipesView extends Div implements AfterNavigationObserver {
